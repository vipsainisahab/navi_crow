  ...
  return (
    <>
      ...
      >
        ...
        <div class="card-name-container"><h4>Travel far enough, meet yourself</h4><h2>DEALS & DISCOUNT</h2></div>
          {/* <div className="row pt-35">
						<div className="col-lg-12 flex">
							<div className="image-list flex-three">
								<img src="/assets/images/avata/6.jpg" alt="Image" className="item" />
								<img src="/assets/images/avata/5.jpg" alt="Image" className="item" />
								<img src="/assets/images/avata/4.jpg" alt="Image" className="item" />
								<img src="/assets/images/avata/3.jpg" alt="Image" className="item" />
								<img src="/assets/images/avata/1.jpg" alt="Image" className="item" />
								<img src="/assets/images/avata/2.jpg" alt="Image" className="item" />
								<div className="icon text-white item flex-five">
									<i className="icon-uniE914" />
								</div>
							</div>
							<p className="client fadeInUp wow">2,500 people booked Tommorow land Event in last 24 hours</p>
						</div>
					</div> */}
          <div className="row">
            {/*<div className="col-lg-6">
              <div className="travel-video relative">
                <img
                  src="/assets/images/about-us/image-video.png"
                  alt="Image"
                ...
                {/* <img
                  src="/assets/images/about-us/vali.png"
                  alt="Image"
                  className="mask-video tf-anime-rorate"
                /> 

                <img
                  src="https://cdn.prod.website-files.com/673db2dcc379e23c771b96fc/673db2ddc379e23c771b98b1_japan-4287832_1920-p-1600.jpeg"
                  alt="Image"
                  className="mask-enjoy w-30"
                />
              </div>
            </div>*/}
            <div className="col-lg-6">
              <div>
                <div className="image-con">
                  ...
                  >
                    <img
                      className="img-container" style={{height:"670px"}}
                      src="/assets/images/about-us/image-video.jpg"
                    />
                    
                    {addToCart.status && addToCart.id === 0 && (
                      <h1 className="addToCart">Add to cart</h1>
                    )}
                    <div className="shadow-color" />
                    <div className="bottomText">
                      <h3>$ 950.00 USD</h3>
                      <p>Adventures in Nainital</p>
                      <p>Get an unforgettable experience from each of our trips! Travel with us!</p>
                    </div>
                  </div>
                </div>
                <div
                  className="lastimageCon"
                  onMouseEnter={() => {
                    setAddtoCart((old) => ({
                      ...old,
                      status: true,
              ...
              {/* <div className="inner-content-about">
                <span className="sub-title-heading text-main mb-15 fadeInUp wow">Explore the
                  world</span>
                <h2 className="title-heading mb-18 fadeInUp wow">Great opportunity fo <span className="text-gray font-yes">adventure</span> &amp; travels</h2>
                ...
                <div className="row mt-27 fadeInUp wow">
                  <div className="col-sm-6">
                    <div className="icon-box-style3">
                      <div className="icon flex-three">
                      ...
                      <h6 className="title mb-10"><Link href="#">Trusted travel guide</Link></h6>
                      <p className="des">Welcome to our Print 128 wesit! company that offers a
                        wide r</p>
                    </div>
                  </div>
                  <div className="col-sm-6">
                    <div className="icon-box-style3">
                      ...
                      <h6 className="title mb-10"><Link href="#">Pesonalized Trips</Link></h6>
                      <p className="des">Welcome to our Print 128 wesit! company that offers a
                        wide r</p>
                    </div>
                  </div>
                </div>
                <div className="flex-three btn-wrap-about mb-30 fadeInUp wow">
                  ...
                  <div className="profile flex-three">
                    <div className="image">
                      <img src="/assets/images/avata/10.jpg" alt="" />
                    </div>
                    <div className="content">
                      <img src="/assets/images/page/name.png" alt="" />
                      <span className="text-main">Ceo &amp; Founder</span>
                    </div>
                  </div>
                </div>
                <div className="map-check flex-three fadeInUp wow">
                  <div className="icon">
                    <svg width={33} height={30} viewBox="0 0 33 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clipPath="url(#clip0_321_31)">
                  ...
                  <span className="text-main">Checkout Beautiful Places Arround the World.</span>
                </div>
              </div> */}
            </div>
            <div className="col-lg-6">
              <div>
                <div className="image-con">
                  ...
                  >
                    <img
                      ...
                      src="https://cdn.prod.website-files.com/673db2dcc379e23c771b96fc/673db2ddc379e23c771b98b0_madagascar-4601287_1920-p-1600.jpeg"
                    />
                    {addToCart.status && addToCart.id === 1 && (
                      <h1 className="addToCart">Add to cart</h1>
                    )}
                    <div className="shadow-color" />
                    <div className="bottomText">
                      <h3>$ 870.00 USD</h3>
                      <p>Heaven of Uttarkashi</p>
                  ...
                  >
                    <img
                      className="img-container"
                      src="https://cdn.prod.website-files.com/673db2dcc379e23c771b96fc/673db2ddc379e23c771b98af_colombia-2462323_1920-p-1600.jpeg"
                    />
                    {addToCart.status && addToCart.id === 2 && (
                      <h1 className="addToCart">Add to cart</h1>
                    )}
                    <div className="shadow-color" />
                    <div className="bottomText">
                ...
                >
                  <div className="thirdImg">
                    <img
                      src="https://cdn.prod.website-files.com/673db2dcc379e23c771b96fc/673db2ddc379e23c771b98ae_trakai-castle-2719711_1920-p-1600.jpeg"
                      alt="image"
                    />
                  </div>
                  {addToCart.status && addToCart.id === 3 && (
                    <h1 className="addToCart">Add to cart</h1>
                  )}
                  <div className="shadow-color" />
                  <div className="bottomText">
