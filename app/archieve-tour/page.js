...
export default function ArchiveTour() {
  ...
  return (
    <>
      <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Archieve Tour">
        <div>
          ...
          <section className="archieve-tour">
            <div className="tf-container">
              <div className="listing-list-car-wrap listing-list-car-wrap-grid3">
                <form action="/" className="tf-my-listing mb-37">
                  <div className="row align-center">
                    ...
                    <div className="col-sm-7  flex-six group-bar-wrap">
                ...
                <div
                  className={`listing-list-car-grid mb-60 ${
                    isTab === 1 ? "listing-list-car-list" : ""
                  }`}
                >
                  ...
                  <div className="tour-listing box-sd">
                    <Link href="/tour-single" className="tour-listing-image">
                      ...
                      <img
                        src="/assets/images/travel-list/5.jpg"
                        alt="Image Listing"
                      />
                    </Link>
                    <div className="tour-listing-content">
                  ...
                  <div className="tour-listing box-sd">
                    <Link href="/tour-single" className="tour-listing-image">
                      ...
                      <img
                        src="/assets/images/travel-list/6.jpg"
                        alt="Image Listing"
                      />
                    </Link>
                    <div className="tour-listing-content">
          ...
          {/* Widget archieve tour */}
          {/* Widget About Us */}
          <section className="about-us-h3 pd-main about-us-archieve relative">
            <div className="bg-archieve-about" />
            <div className="tf-container ">
              <div className="row z-index3 relative">
                <div className="col-md-6">
                  <div className="about-us-h3-image relative">
                    <img
                      src="/assets/images/page/explore3.jpg"
                      alt="image"
                    ...
                    <div className="about-vector">
                      ...
                      <span className="font-yes text-white">
                        Never stop Exploring
                      </span>
                    </div>
                    <p className=" center">
                      <span className="text-main">2,500</span> people booked
                      Tommorow land Event in last 24 hours
                    </p>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="about-us-h3-content">
                    <div className="mb-18">
                      <span className="sub-title-heading text-main font-yes fs-28-46">
                        Explore the world
                      </span>
                      <h2 className="title-heading mb-18">
                        Great opportunity for{" "}
                        <span className="booking-title">
                          <span className="booking">
                            adventure <span className="dot" />
                          </span>
                        </span>
                        &amp; travels
                      </h2>
                    ...
                    <p className="text-main ranger-suport mb-32">
                      a range of programs and supports in the disability
                      including:
                    </p>
                    <ul className="list-icon mb-37">
                      <li>
                      ...
                      <li>
                        <i className="icon-Group-13" />
                        <span>
                          Let your local host tailor the tourcompletely to your
                          wish.
                        </span>
                      </li>
                    </ul>
                    <div className="about-wrap flex-three">
                      <div className="image-list flex-three">
                        <img
                          src="/assets/images/avata/6.jpg"
                          alt="Image"
                          className="item"
                        />
                        <img
                          src="/assets/images/avata/5.jpg"
                          alt="Image"
                          className="item"
                        />
                        <img
                          src="/assets/images/avata/4.jpg"
                          alt="Image"
                          className="item"
                        />
                        <img
                          src="/assets/images/avata/3.jpg"
                          alt="Image"
                          className="item"
                        />
                        <img
                          src="/assets/images/avata/1.jpg"
                          alt="Image"
                          className="item"
                        />
                        <img
                          src="/assets/images/avata/2.jpg"
                          alt="Image"
                          className="item"
                        />
                        <div className="icon text-white item flex-five">
                          <i className="icon-uniE914" />
                        </div>
                      </div>
                      <Link href="#" className="btn-main">
                        <p className="btn-main-text">More about us</p>
                        <p className="iconer">
